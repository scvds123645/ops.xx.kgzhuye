      ...
      <div className="max-w-md w-full">
        ...
        <div className="bg-white/95 backdrop-blur-sm rounded-3xl shadow-2xl p-8 transform hover:scale-105 transition-transform duration-300">
          ...
          <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-2xl p-4 mb-6 border border-blue-100">
            <p className="text-center text-gray-500 text-sm mb-1">Telegram 频道</p>
            <p className="text-center text-2xl font-bold text-blue-600 font-mono">
              {telegramChannel}
            </p>
          </div>
          ...
          <a
            ...
            className="block w-full bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white font-bold py-4 px-6 rounded-2xl text-center transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1"
          >
